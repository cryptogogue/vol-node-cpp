...
public:
    ...
    static void     expand                  ( const AbstractLedger& ledger, string accountName, const SerializableSet < AssetID::Index >& indexSet, SerializableList < SerializableSharedConstPtr < Asset >>& assetList );
