...
public:
    ...
    //----------------------------------------------------------------//
    LedgerResult                        awardAssets                 ( const Schema& schema, AccountID accountID, string assetType, size_t quantity, time_t time );
    LedgerResult                        awardAssetsAll              ( const Schema& schema, AccountID accountID, size_t quantity, time_t time );
    LedgerResult                        awardAssetsRandom           ( const Schema& schema, AccountID accountID, string deckName, string seed, size_t quantity, time_t time );
    ...
    LedgerResult                        upgradeAssets               ( const Schema& schema, AccountID accountID, const map < string, string >& upgrades, time_t time );
};
